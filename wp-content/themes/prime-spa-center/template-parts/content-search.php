	...
	<div id="featured-posts" class="post-item">
		...
		<div class="entry-container">
			...
			<ul class="auther-comment">
				...
				<a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>" class=""> <?php echo esc_html_e('By','prime-spa-center'); ?> <?php esc_html(the_author()); ?></a></li>
				<li><a href="javascript:void(0);" class=""><?php echo esc_html(get_comments_number($post->ID)); ?> comment</a></li>
			</ul>
			<div class="entry-content">
				<?php
					$excerpt = prime_spa_center_the_excerpt( 15 );
					echo wp_kses_post( wpautop( $excerpt ) );
				?>
			</div><!-- .entry-content -->

			<?php $readmore_text = prime_spa_center_get_option( 'readmore_text' );?>
